...
All publicly accessible Federal websites and <a class="footnote" name="footnote-source-1"></a>web services [[1]](#footnote-1) only provide service over a secure connection. The strongest privacy protection currently available for public web connections is Hypertext Transfer Protocol Secure (HTTPS).
...
Private and secure connections are becoming the Internet’s baseline, as expressed by the policies of the Internet's [standards](http://www.w3.org/2001/tag/doc/web-https) [bodies](http://www.internetsociety.org/news/internet-society-commends-internet-architecture-board-recommendation-encryption-default), popular web browsers, and the Internet community of practice. The Federal government must adapt to this changing landscape, and benefits by beginning the conversion now. Proactive investment at the Federal level will support faster internet-wide adoption and promote better privacy standards for the entire browsing public.
...
Please **[provide public feedback and suggestions](https://github.com/WhiteHouse/https/#we-want-your-feedback)** for this proposal and technical assistance materials, or email [`https@cio.gov`](mailto:https@cio.gov) to provide private comments.
